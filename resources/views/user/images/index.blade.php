        ...
        <div class="container">
            <div class="col-md-12">
                ...
                @if($itemsthumbnail==null)
                    ...
                    <br>
                    <form method="post" action="{{route('user.userstorethumbnail',$id)}}" enctype='multipart/form-data'>
                        {!! csrf_field() !!}
                        ...
                        <table class="table table-dark">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post"
                                          action="{{route('user.userupdatethumbnail',[$id,$itemsthumbnail->id])}}"
                                ...
                                <td>
                                    <form method="post"
                                          action="{{route('user.userdeletethumbnail',[$id,$itemsthumbnail->id])}}"
                                          enctype='multipart/form-data'>
                                        {{ method_field('delete') }}
                                        {!! csrf_field() !!}
                        ...
                        @foreach($images as $key=> $image)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" action="{{route('user.updateuserimage',$image->id)}}"
                                          enctype='multipart/form-data'>
                                        {!! csrf_field() !!}
                                        {{ method_field('patch') }}
                                        <div class="col-sm-12">
                                ...
                                <td>
                                    <form method="post" action="{{route('user.destroyuserimage',$image->id)}}"
                                          enctype='multipart/form-data'>
                                        {{ method_field('delete') }}
                                        {!! csrf_field() !!}
        ...
        <tr>
              ...
              <td>{{$image->id}}</td>
						      ...
						      <td>
							      	...
							      	<form method="post" action="{{route('user.updateuserimage',$image->id)}}" enctype='multipart/form-data'>
							      		 {!! csrf_field() !!}
        {{ method_field('patch') }}
                <div class="col-sm-12">
                     <div class="input-group">
...
@endif
                ...
                <td>
                        <form  method="post" action="{{route('user.destroyuserimage',$image->id)}}" enctype='multipart/form-data'>
						 	 			  {{ method_field('delete') }}
        {!! csrf_field() !!}
