                ...
                <div id="accordion">
                    ...
                    @if($message->read_msg=='no'||$message->read_msg=='NULL'||$message->read_msg=='')
                        <div class="card2" data-id="{{$message->id}}"
                             data-action="{{route('readmessage',$message->id)}}" name="readmsgs" data-toggle="collapse"
                        ...
                        <br>
                    @else
                        <div class="card" data-toggle="collapse" data-target="#{{$message->id}}" aria-expanded="true"
