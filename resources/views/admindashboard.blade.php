        ...
        <div class="row justify-content-center">
            <div class="col-md-2">
                <div class="side-navbar">
                    <nav class="navbar navbar-expand-md navbar-light admin-nav">
                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <ul class="navbar-nav mr-auto mt-2 mt-lg-0 nav-block bg-dark ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('admin.showprofile',Auth::user()->id)}}"> My
                                        Profile</a>
                                </li>
                                <li class="nav-item active">
                                    <a class="nav-link" href="{{route('admin.category.index')}}">Category <span
