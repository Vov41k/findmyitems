...
<div class="container container-main">
    <div class="container-main-button">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 mb-2">
                <button id="openNav" class="btn btn-lg btn-block mb-2" style="font-size:20px;cursor:pointer">Open Menu</button>
            </div>
            </div>
        </div>
    ...
    <div class="contents">
        <div class="row">
                ...
                <div class="newcontent col-sm-12 col-12 col-md-12 col-lg-11">
                                              ...
                                              <article class="article thumb-article mb-0 ">
                                                ...
                                                <div class="article-body position-absolute article-item-body bg-dark">
                                                  ...
                                                  <ul class="article-meta">
                                                    ...
                                                    <li><i class="fa fa-comments"></i> {{ $item->commentscount($item->id)}}</li>
                                                  </ul>
                                                </div>
                                              </article>
                                         </a>
